...
This decision was probably meant to encourage writing more thoughtful and constructive comments, which is just my guess becuase there's no official explanation, but instead it discourages me from writing comments at all. And I'm not the only one:
...
I can actually read this. ☝️

## Custom domain

I bought a custom domain for my publication. It was pretty pricy for just connecting a subdomain that I already owned, but I didn't want to depend on Medium's domain in case I want to switch to something else later on. (For example, now. 😄)
