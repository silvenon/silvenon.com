...
export const meta = {
  title: "Mocking with Jest: Spying on Functions and Changing their Implementation",
  lang: "EN",
  category: "DEV",
  lastModified: "",
  isHidden: false,
...
<p>What about modules? See how you can mock modules on different levels by <Link to="/blog/mocking-modules-with-jest">taking advantage of the module system</Link>.</p>
