...
description: Splitting large JSX expressions into functions affects readability in the sense that the reader has to look elsewhere in order to understand the expression.
category: DEV
