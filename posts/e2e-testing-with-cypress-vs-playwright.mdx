...
Speed wasn't the only factor, another problem was that it was often taking me a long time to figure out how to write my tests, I don't find Cypress' documentation to be organized that well at the moment. For example, it took me a long time to figure out how to use `should()`, as arguably the most important part of Cypress I expected to be able to learn about it in one place, but the documentation kept throwing me in different directions as I tried to dig deeper. I'm still wondering whether there's something more I can learn about it.
