...
description: The best code rules are not written, they are enforced. Find out how to create your own ESLint rules using an existing rule and syntax tree selectors.
category: DEV
...
ASTs are powerful, you can use them to build Babel plugins, write codemods, all kinds of crazy stuff! For example, I use them to [check my blog posts for dead URLs](/blog/checking-for-dead-urls).

[rules]: https://eslint.org/docs/latest/rules/
[plugins]: https://npms.io/search?q=eslint-plugin
[lint-staged]: https://github.com/okonet/lint-staged
[eslint-config-airbnb]: https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb
[authoring rules]: https://eslint.org/docs/latest/developer-guide/working-with-rules
[authoring plugins]: https://eslint.org/docs/latest/developer-guide/working-with-plugins
[no-restricted-syntax]: https://eslint.org/docs/latest/rules/no-restricted-syntax
[selector]: https://eslint.org/docs/latest/developer-guide/selectors
[selector-syntax]: https://eslint.org/docs/latest/developer-guide/selectors#what-syntax-can-selectors-have
