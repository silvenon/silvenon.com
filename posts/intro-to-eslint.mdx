...
description: Many view ESLint as a nuissance, but if used correctly it can improve the quality of your project and even teach you JavaScript.
category: DEV
published: 2016-06-01
---

If you've never tried [ESLint](https://eslint.org/), I strongly recommend it. Setting it up will make things:
...
[babel-experimental]: https://babeljs.io/docs/en/plugins/#experimental
[babel-eslint]: https://github.com/babel/babel-eslint
[jsx-no-bind]: https://github.com/jsx-eslint/eslint-plugin-react/blob/82b3aa9101aa2124b934add61734cec026b4c278/docs/rules/jsx-no-bind.md
[eslint-plugin-import]: https://github.com/import-js/eslint-plugin-import
[eslint-editor-plugins]: https://eslint.org/docs/latest/user-guide/integrations#editors
