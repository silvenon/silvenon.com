...
description: Many meta frameworks now place Vite between the framework and the developer. Let's explore what this means for us in comparison to a framework that isn't built this way.
