...
description: Redux was created when React Context was still experimental, learn how to imitate Redux using modern React API, based on a few posts by Kent C. Dodds.
category: DEV
