  ...
  return (
    <>
      <div className="flex items-center space-x-2">
        ...
        >
          <span className="dark-mode-label-on sr-only" aria-hidden={true}>
            Disable dark mode
          </span>
          <span className="dark-mode-label-off sr-only" aria-hidden={false}>
            Enable dark mode
          </span>
        ...
        dangerouslySetInnerHTML={{
          __html: dedent`
            ;(() => {
              ...
              const labelOnEl = document.querySelector('.dark-mode-label-on')
              const labelOffEl = document.querySelector('.dark-mode-label-off')
              ...
              function updateSwitch() {
                ...
                labelOnEl.setAttribute('aria-hidden', String(!isDarkMode))
                labelOffEl.setAttribute('aria-hidden', String(isDarkMode))
              }
            })()
          `,
        }}
